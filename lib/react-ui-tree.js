...
module.exports = React.createClass({
  ...
  drag(e) {
    ...
    var diffY = dragging.y + dragging.h/2 - (index.top-1) * dragging.h;
    ...
    console.log("Node '" + index.node.module + "' hasSiblingsAbove=" + hasSiblingsAbove, "hasSiblingsBelow="+hasSiblingsBelow);

    // console.log("above:" + (above ? above.node.module : "N/A"));
    // console.log("below:" + (below ? below.node.module : "N/A"));
    if(allowYMove && hasSiblingsAbove && diffY < 0) { // up
      console.log("   ==> MOVED UP!");
      // var above = tree.getNodeByTop(index.top-1);
      newIndex = tree.move(index.id, above.id, 'before');
    } else if(allowYMove && hasSiblingsBelow && diffY > dragging.h) { // down
